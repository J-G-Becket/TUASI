...
if (!empty($_POST)) {
	...
	if ($_POST['new_mode'] == 1){
		$resultsEXP = "INSERT INTO searchesuser (url) VALUES ('$URLToRate') ON DUPLICATE KEY UPDATE rateup = rateup + 1;";	
		}
	else if ($_POST['new_mode'] == 2){
		$resultsEXP = "INSERT INTO searchesuser (url) VALUES ('$URLToRate') ON DUPLICATE KEY UPDATE ratedown = ratedown + 1;";
		}
	else {
		die();
		}
